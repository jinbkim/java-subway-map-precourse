...
- [x] 3항 연산자 사용하지 않기
- [x] 메소드 최대 길이 15
- [x] 메소드는 한가지 일만 하도록 구현
- [x] else 사용하지 않기

## 프로그래밍 요구사항 - Station, Line

- [x] 각 클래스의 기본 생성자를 추가할 수 없음
- [x] 인스턴스 변수 name의 접근 제어자는 private
- [x] setter 메소드 구현하지 않기

## 프로그래밍 요구사항 - StationRepository, LineRepository

- [x] 객체들의 상태를 XXXRepository 클래스를 활용해 저장 로직을 구현